...
class Planeta(object):
    """
    La clase planeta, crea un planeta dadas su condiciones iniciales de posicion y velocidad
    ademas de un alpha opcional.Posee metodos para la ecuacion de
    movimiento de este, y los metodos de runge Kutta 4, Verlet y Beeman que
    avanzan un paso. Tambien se puede calcular la energía total del planeta en las condiciones actuales
    """
